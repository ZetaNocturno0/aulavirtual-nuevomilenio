...
<form id="form1" name="form1" method="post" action="controladores/ClaseController.php" onSubmit="return validar(this)" enctype="multipart/form-data" >
  ...
  <table align="center" class="table-hover table-condensed">
    ...
    <tr>
      ...
      <td> 
		...
		<td>Carrera</td>
		<td>
			<select name="codcarrera" class="form-control">
				<option value="1"> Marketing Empresarial </option>
  ...
  <table align="center" width="554" class="table-hover table-condensed">			
    <tr>
      <td width="546" height="83" colspan="4" align="right" >
	  	  <input type="hidden" name="idcliente" value="<? echo $idcliente ?>" />
		  <input type="hidden" name="cliente" value="<? echo $cliente ?>" />
	  <input type="submit" name="Submit" value="Registrar Clase" class="btn-success btn" <?php echo $dis;?>
	  />	
